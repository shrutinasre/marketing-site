  ...
  return (
    <motion.div whileHover={{ y: -6 }} transition={{ duration: 0.25, ease: "easeOut" }}>
      <Link
        ...
        className="focus-ring group flex h-full flex-col rounded-card border border-neutral-200 bg-white p-6 transition-colors duration-300 hover:border-blue-300 hover:shadow-xl hover:shadow-blue-500/10"
      >
        <motion.div
          whileHover={{ rotate: 6 }}
